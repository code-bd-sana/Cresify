        ...
        <div className="w-full max-w-2xl bg-white rounded-3xl shadow-xl p-8 border border-[#EFE9FF]">
          ...
          <form onSubmit={handleLogin}>
            ...
            <div className="flex items-center justify-between mt-3">
              ...
              <button 
                type="button" 
                className="text-sm text-[#F88D25] hover:text-[#E95D9F] transition"
            ...
            <button 
              type="submit"
              className="w-full mt-6 py-3 rounded-xl text-white font-medium bg-gradient-to-r from-[#F88D25] to-[#E95D9F] hover:opacity-90 transition hover:shadow-lg"
            >
              Login
            </button>
          </form>
          ...
          <button 
            ...
            className="w-full py-3 flex items-center justify-center gap-2 text-gray-700 border border-gray-300 rounded-xl hover:bg-gray-50 transition hover:border-[#4285F4] hover:shadow-sm"
          >
          ...
          <Link href="/register/seller">
            <button className="w-full mt-3 py-3 rounded-xl text-white font-medium bg-gradient-to-r from-[#9C6BFF] to-[#F88D25] hover:opacity-90 transition hover:shadow-lg">
          ...
          <div className="flex gap-3 mt-4">
            ...
            <Link href="/register/buyer" className="flex-1">
              <button className="w-full py-3 border border-gray-300 rounded-xl text-gray-700 hover:bg-gray-50 transition text-center hover:border-[#9C6BFF] hover:text-[#9C6BFF]">
                Register as a Buyer
              </button>
            </Link>
            ...
            <Link href="/register/provider" className="flex-1">
              <button className="w-full py-3 border border-[#F88D25] text-[#F88D25] rounded-xl hover:bg-orange-50 transition text-center hover:border-[#E95D9F] hover:text-[#E95D9F]">
          ...
          <div className="mt-6 p-4 bg-gradient-to-r from-[#F3F8FF] to-[#FFF3E5] border border-[#D4E6FF] rounded-xl text-sm text-gray-700">
            ...
            <div className="space-y-1">
              <p className="flex items-center gap-2">
                ...
                <code className="bg-gray-100 px-2 py-1 rounded text-[#6A11CB]">demo@cresify.com</code>
              </p>
              <p className="flex items-center gap-2">
                <span className="text-[#F88D25]">🔑</span>
                <span className="font-medium">Password:</span> 
                <code className="bg-gray-100 px-2 py-1 rounded text-[#6A11CB]">demo123</code>
              </p>
            </div>
