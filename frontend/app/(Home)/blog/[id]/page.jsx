...
const BlogDetailspage = () => {
  ...
  const getImageSrc = () => {
    ...
    if (
      singleBlog.img &&
      (singleBlog.img.startsWith("http") || singleBlog.img.startsWith("https"))
    ) {
        ...
        <div className='max-w-4xl mx-auto'>
          ...
          <div className='bg-white rounded-[20px] overflow-hidden p-8 border border-[#EAEAEA] text-center'>
            ...
            <Link
              ...
              {t("blog:details.notFound.browseButton")}
            </Link>
          </div>
        </div>
      </div>
      ...
      <div className='max-w-4xl mx-auto'>
        ...
        <div className='bg-white rounded-[20px] overflow-hidden p-6 border border-[#EAEAEA]'>
          ...
          <div className='relative w-full h-96 mb-6'>
            <Image
              src={getImageSrc()}
              alt={singleBlog.title || t("blog:common.placeholders.imageAlt")}
              fill
          ...
          <div className='mb-4'>
            <span
              ...
              <FaTag /> {getCategoryName(singleBlog.category)}
            </span>
          </div>
          ...
          <div className='flex flex-wrap items-center gap-4 text-gray-600 mb-6 pb-6 border-b border-gray-100'>
            ...
            {singleBlog.author && (
              <div className='flex items-center gap-2'>
                ...
                <span className='text-sm'>
                  {t("blog:details.meta.author")}: {singleBlog.author}
                </span>
              </div>
            )}
          </div>
            ...
            <div className='text-gray-700 leading-relaxed space-y-4'>
              {singleBlog.description ? (
                ...
                <p className='text-base md:text-lg'>
                  {singleBlog.description ||
                    t("blog:common.placeholders.noContent")}
                </p>
              )}
            </div>
            ...
            {singleBlog.content && (
              <div className='mt-8 pt-6 border-t border-gray-100'>
                <h2 className='text-2xl font-bold text-gray-900 mb-4'>
                  {t("blog:details.content.analysis")}
                </h2>
        ...
        <div className='mt-8 text-center'>
          <p className='text-gray-600 mb-4'>
            {t("blog:details.content.share")}
          </p>
          <div className='flex justify-center gap-4'>
            <Link
              href='/blog'
              className='inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-[#9838E1] to-[#F68E44] text-white font-semibold rounded-lg hover:opacity-90 transition-opacity'>
              {t("blog:details.content.browseMore")}
            </Link>
          </div>
        </div>
      </div>
