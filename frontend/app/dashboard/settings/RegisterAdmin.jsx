...
const RegisterAdmin = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.error) {
        throw new Error(response.error.data?.message || "Admin registration failed");
      }
      ...
      <div className="max-w-md w-full">
        <div className="bg-white rounded-lg shadow-md p-8">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600 mt-2">Create administrator account</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            >
              {userLoading ? "Creating..." : "Create Admin Account"}
            </button>
          </form>
