  ...
  if (isLoading) {
    return (
      <div className='w-full min-h-screen px-2 pt-6'>
        ...
        <p className='text-sm text-[#9c6bff] mt-1'>{t("reviews.subtitle")}</p>
              ...
              <div className='flex items-start gap-4'>
                ...
                <div className='relative w-12 h-12'>
                  <Image
                    ...
                    alt={item.user?.name || t("reviews.anonymousUser")}
                    width={48}
                    height={48}
                  ...
                  <div className='flex justify-between items-start'>
                    <div>
                      <h3 className='text-[16px] font-semibold text-gray-800'>
                        {item.user?.name || t("reviews.anonymousUser")}
                      </h3>
                      <p className='text-sm text-[#9c6bff]'>
                        {item.product?.name || t("reviews.unknownProduct")}
                      </p>
                    </div>
