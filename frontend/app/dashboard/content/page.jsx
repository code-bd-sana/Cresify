  ...
  const handleSubmit = () => {
    if (editingArticle) {
      console.log("Updating article:", {
        index: editingArticle.index,
        title,
        category,
        details,
        image,
      });
      // Here you would update the article in your state/database
    } else {
      console.log("Creating new article:", { title, category, details, image });
      // Here you would create a new article
    }
