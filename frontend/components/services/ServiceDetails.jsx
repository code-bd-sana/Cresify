      ...
      <div className="max-w-[1300px] mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="pt-2">
            ...
            {/* Category */}
            <p className="text-[13px] text-[#9838E1] mt-[2px]">Electrical</p>
            ...
            <div className="mt-5">
              ...
              <p className="text-[13px] text-[#6A6A6A] leading-[20px] max-w-[420px]">
                Smart Electricians provides safe and reliable electrical
                services for homes and businesses. Our certified electricians
                handle installations, repairs, and upgrades with precision and
                adherence to all safety codes.
              </p>
            </div>
