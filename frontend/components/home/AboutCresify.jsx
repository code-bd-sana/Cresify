      ...
      <div className="max-w-[1350px] mx-auto flex flex-col lg:flex-row items-center gap-16">
        ...
        <div className="flex-1">
          ...
          <p className="text-[15px] text-[#000000] leading-[24px] max-w-[550px] mb-6">
            CRESIFY is more than just a marketplace – we’re a community connecting
            people with the products and services they need, right in their neighborhood.
          </p>

          <p className="text-[15px] text-[#000000] leading-[24px] max-w-[550px] mb-10">
            Founded with a mission to empower local businesses and make quality services
            accessible to everyone, we’ve grown into Latin America’s trusted platform for
