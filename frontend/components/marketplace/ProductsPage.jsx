        ...
        <aside className="hidden lg:block w-[270px]">
          <div className="bg-white rounded-[18px] p-6 shadow-[0_4px_24px_rgba(0,0,0,0.06)] border border-[#F2EEF9]">
            ...
            <div className="flex items-center justify-between mb-6">
              ...
              <button className="text-[12px] text-[#F78D25] font-medium hover:underline">
                Clean everything
              </button>
            </div>
            ...
            <div className="mb-8">
              ...
              <div className="space-y-2">
                {[5, 4, 3, 2, 1].map((stars) => (
                  ...
                  >
                    <input type="radio" className="h-[14px] w-[14px]" />
            ...
            <div className="mb-7">
              ...
              <select className="w-full border border-[#E4DDF5] rounded-[12px] px-3 py-2 text-[13px] text-[#444] outline-none">
